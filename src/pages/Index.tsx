...
const channels = [
  ...
  },
  {
    ...
    items: [
      { name: "новости", locked: false, emoji: "📰" },
      { name: "общение", locked: false, emoji: "💬" },
    ],
    voice: [
      "🏛️ Общая комната 1",
      "🏛️ Общая комната 2",
      "⭐ Старшая администрация 1",
      "⭐ Старшая администрация 2",
      "📋 Общее собрание",
  ...
  {
    category: "🛡️ Модераторы Discord",
    items: [
      { name: "новости-модов", locked: false, emoji: "📰" },
      { name: "общение-модов", locked: false, emoji: "💬" },
    ],
    voice: [
      "🏠 Общая комната 1",
      "🏠 Общая комната 2",
      "📋 Общее собрание",
      "⭐ Старшие модераторы 1",
      "⭐ Старшие модераторы 2",
      "👑 Главные модераторы",
      "🎯 Руководство модов",
    ],
  },
  {
    category: "🎧 Агенты поддержки",
    items: [
      { name: "новости-поддержки", locked: false, emoji: "📰" },
      { name: "общение-поддержки", locked: false, emoji: "💬" },
    ],
    voice: [
      "🏠 Общая комната",
      "📋 Общее собрание",
